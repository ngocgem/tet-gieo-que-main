  ...
  return (
    <div className="flex flex-col items-center gap-4 relative">
      ...
      <motion.button
        ...
        className="w-full py-3.5 rounded-2xl border-2 border-primary/50 text-primary font-display font-semibold text-base hover:bg-primary/10 transition-all active:scale-95"
      >
        🔄 Thử lại lần nữa
      </motion.button>
      ...
      {onExit && (
        <motion.button
          ...
          className="text-tet-cream-text/50 hover:text-tet-cream-text/80 text-sm font-light transition-colors"
        >
          Thoát
        </motion.button>
      )}
